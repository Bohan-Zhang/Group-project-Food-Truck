...
public class DessertsFoods {
    ...
    public Food brownie = new Food("Brownie", 2.75, 250, "Two rich chocolate brownies.");
    public Food chocolateChipCookie = new Food("Chocolate Chip Cookie", 1.00, 200, "A classic chocolate chip cookie.");
    public Food butterCookie = new Food("Butter Cookie", 1.00, 200, "A classic butter cookie.");
    public Food applePie = new Food("Baked Apple Pie", 2.00, 250, "A warm turnover handpie filled with spiced apples.");

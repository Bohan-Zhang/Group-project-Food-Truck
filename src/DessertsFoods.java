...
public class DessertsFoods {
    ...
    public DessertsFoods() {
        vanillaIceCream = new Food("Vanilla Ice Cream", 3.50, 250, "Soft-served vanilla ice cream.",5,                  new ImageIcon((Objects.requireNonNull(getClass().getResource("img/VanillaIceCream.png")))));
        chocolateIceCream = new Food("Chocolate Ice Cream", 3.50, 250, "Soft-served chocolate ice cream.",5,            new ImageIcon((Objects.requireNonNull(getClass().getResource("img/ChocolateIceCream.png")))));

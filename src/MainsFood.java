...
public class MainsFood {
    ...
    public Food hamburger = new Food("Hamburger", 6.00, 800, "juicy beed patty with condiments that is between 2 buns", 10, new ImageIcon((Objects.requireNonNull(getClass().getResource("img/name.png")))));
    ...
    public Food hotdog = new Food("Hotdog", 4.00, 400, "grilled sausage in a bun with condiments", 10, new ImageIcon((Objects.requireNonNull(getClass().getResource("img/name.png")))));
    ...
    public Food tacos = new Food("Tacos", 7.00, 700, "5 soft shell tacos with beef, lettuce, cheese, and condiments", 10, new ImageIcon((Objects.requireNonNull(getClass().getResource("img/name.png")))));

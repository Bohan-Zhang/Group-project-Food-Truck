...
public class MainsFood {
    ...
    public Food pizza = new Food("Pizza", 8.00, 900, "sliced pizza with pepperoni and cheese", 10, new ImageIcon((Objects.requireNonNull(getClass().getResource("img/Pizza.png")))));
    ...
    public Food pasta = new Food("Pasta", 9.00, 850, "spaghetti pasta with marinara sauce and meatballs", 10, new ImageIcon((Objects.requireNonNull(getClass().getResource("img/Pasta.png")))));
    public Food turkeySandwich = new Food("Turkey Sandwich", 6.50, 650, "sliced turkey breast with lettuce, tomato, and condiments on whole wheat bread", 10, new ImageIcon((Objects.requireNonNull(getClass().getResource("img/Turkey sandwich.png")))));
    public Food grilledCheese = new Food("Grilled Cheese", 4.50, 500, "melted cheese between 2 slices of buttered grilled bread", 10, new ImageIcon((Objects.requireNonNull(getClass().getResource("img/Grilled cheese.png")))));
